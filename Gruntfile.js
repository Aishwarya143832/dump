  ...
  grunt.initConfig({
    ...
    connect: {
        options: {
            ...
            hostname: 'localhost',
            livereload: 35729,
            open:'http://<%= connect.options.hostname %>:<%= connect.options.port %>?baseApiUrl=http://internal-vx-k8s-in-elb-nexus-k8s-dev1-1816675946.eu-west-1.elb.amazonaws.com/fineract'
        },
        livereload: {
            options: {
                base: [
